...
HD_PWD='C:/Projects/ML On FPGA/ML_Regression_fil/fpgaproj/ML_Regression_fil.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ML_Regression_fil.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ML_Regression_fil.tcl -notrace
