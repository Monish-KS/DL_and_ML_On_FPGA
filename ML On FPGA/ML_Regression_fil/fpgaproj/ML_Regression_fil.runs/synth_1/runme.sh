...
HD_PWD='C:/Projects/ML On FPGA/ML_Regression_fil/fpgaproj/ML_Regression_fil.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ML_Regression_fil.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ML_Regression_fil.tcl
