...
HD_PWD='C:/Projects/DL FPGA/DNN_Subsystem_fil/fpgaproj/DNN_Subsystem_fil.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DNN_Subsystem_fil.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DNN_Subsystem_fil.tcl -notrace
