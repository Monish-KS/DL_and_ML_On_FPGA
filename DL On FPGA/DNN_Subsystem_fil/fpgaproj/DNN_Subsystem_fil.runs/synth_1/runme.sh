...
HD_PWD='C:/Projects/DL FPGA/DNN_Subsystem_fil/fpgaproj/DNN_Subsystem_fil.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DNN_Subsystem_fil.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DNN_Subsystem_fil.tcl
